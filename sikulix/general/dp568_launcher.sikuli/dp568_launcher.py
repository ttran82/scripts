...
def Read_SDI_Audio_Format():
    if Get_arg('checkAudio'):
        dragDrop(Pattern("SDI_detection.png").similar(0.90).targetOffset(-26,23),Pattern("SDI_detection.png").similar(0.90).targetOffset(168,487))   
        Control_C() 
        ...
        if checkvideo == '1':
            ...
            if exists("InputASISDI_label.png"):
                ...
                if exists(Pattern("asi_detection.png").similar(0.90)):
                    Print_debug('Detecting ASI input')
                elif exists(Pattern("SDI_detection.png").similar(0.90)):
                    Print_debug('Detecting SDI input')
