...
<?php
  ...
  print "<hr></hr>\n";
  $hostfile = "$qa_logsdir/statmuxhostname.lst";
  print privGetPriviledgesTag();
  if (privIsPriviledged()) {
    print "<li><a href=\"/process_file.php?editfile=$hostfile\" title=\"Edit File\">Edit Statmux Monitor List</a></li>\n";
    print "<li><a href=\"/cgi-bin/drraw.cgi\" title=\"Edit Bugs Chart\">Edit Statmux Bugs Chart</a></li>\n";
  }
?>
