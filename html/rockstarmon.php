<?php
  ...
  navDefine("main", "/nav_main.inc", "current", "r_monitor");
  crumbSet("Rockstar QA Monitor - Update every 1 mintue");
?>
...
<?php
  $filename = "$qa_logsdir/rockstarstatus";
...
<?php
  ...
  print "<hr></hr>\n";
  $hostfile = "$qa_logsdir/rockstarhostname.lst";
  print privGetPriviledgesTag();
  if (privIsPriviledged()) {
    print "<li><a href=\"/process_file.php?editfile=$hostfile\" title=\"Edit File\">Edit Rockstar Monitor List</a></li>\n";
    print "<li><a href=\"/cgi-bin/drraw.cgi\" title=\"Edit Bugs Chart\">Edit Rockstar Bugs Chart</a></li>\n";
  }
?>
