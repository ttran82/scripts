<?php
  ...
  crumbSet("Zodiac QA Monitor - Update every 1 mintue");
?>
...
<b>
<!--<li><a href="/process_file.php?readfile=/home/ttran/html/tests/reports/zodiacbugs.txt">Current Bugs Status (Text View)</a></li>-->
<li>View: <a href="/cgi-bin/drraw.cgi?Mode=view;Graph=1154738181.25897">Current Bugs Status Chart</a> | <a href="http://dev/bugzilla/buglist.cgi?product=Zodiac&amp;bug_status=NEW&amp;bug_status=ASSIGNED&amp;bug_status=REOPENED">Open Bugs</a> | <a href="http://dev/bugzilla/buglist.cgi?product=Zodiac&amp;bug_status=RESOLVED&amp;resolutions=FIXED">Fixed Bugs</a></li>
<li>Download: <a href="http://dev/builds-zodiac.php">Zodiac Releases</a> | <a href="http://opsweb/ZODIAC_DOM/">Zodiac DOM Images</a></li>
<li><a href="/zodiac_tempsensors.php">Zodiac Temperature Sensors</a></li>
</b>
<?php
  $filename = "$qa_logsdir/zodiacstatus";
...
<?php
  ...
  print "<hr></hr>\n";
  $hostfile = "$qa_logsdir/zodiachostname.lst";
  print privGetPriviledgesTag();
  if (privIsPriviledged()) {
    print "<li><a href=\"/process_file.php?editfile=$hostfile\" title=\"Edit File\">Edit Zodiac Monitor List</a></li>\n";
    print "<li><a href=\"/cgi-bin/drraw.cgi\" title=\"Edit Bugs Chart\">Edit Zodiac Bugs Chart</a></li>\n";
  }
?>
