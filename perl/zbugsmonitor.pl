...
$openbugscmd = "http://dev/bugzilla/buglist.cgi?product=Zodiac&bug_status=NEW&bug_status=ASSIGNED&bug_status=REOPENED";
$fixedbugscmd = "http://dev/bugzilla/buglist.cgi?product=Zodiac&bug_status=RESOLVED&resolutions=FIXED";
$closedbugscmd = "http://dev/bugzilla/buglist.cgi?product=Zodiac&bug_status=VERIFIED&bug_status=CLOSED";
$lynxcmd = "lynx -dump";
$rrdtool = "/usr/local/rrdtool/bin/rrdtool";
$rrdfile = "/home/ttran/html/drraw/data/zodiacbug.rrd";
