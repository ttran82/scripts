...
use vars qw($product $rrdfile);

$date = `date \"+%D %R\"`;
chomp($date);
print STDERR "Today's date: $date\n";
$lfile = "$basedir/../logs/vodxbugs.log";
$ofile = "$basedir/../reports/vodxbugs.txt";
$product = "VODxchange";

$header = "#Date\t\tOpenBugs\tFixedBugs\tClosedBugs\tTotal";
$openbugscmd = "http://europe/bugzilla/buglist.cgi?product=$product&bug_status=NEW&bug_status=ASSIGNED&bug_status=REOPENED";
$fixedbugscmd = "http://europe/bugzilla/buglist.cgi?product=$product&bug_status=RESOLVED&resolutions=FIXED";
$closedbugscmd = "http://europe/bugzilla/buglist.cgi?product=$product&bug_status=VERIFIED&bug_status=CLOSED";
$lynxcmd = "lynx -dump";
$rrdtool = "/usr/local/rrdtool/bin/rrdtool";
$rrdfile = "/home/ttran/html/drraw/data/vodx1_0.rrd";
