...
use vars qw($ver $data);

$ver = "2.0";
$data = "zodiacbug2_0.rrd"

$date = `date \"+%D %R\"`;
chomp($date);
print STDERR "Today's date: $date\n";
$lfile = "$basedir/../logs/zodiac2.0bugs.log";
$ofile = "$basedir/../reports/zodiac2.0bugs.txt";

$header = "#Date\t\tOpenBugs\tFixedBugs\tClosedBugs\tTotal";
$openbugscmd = "http://dev/bugzilla/buglist.cgi?keywords=zodiac-$ver&bug_status=NEW&bug_status=ASSIGNED&bug_status=REOPENED";
$fixedbugscmd = "http://dev/bugzilla/buglist.cgi?keywords=zodiac-$ver&bug_status=RESOLVED&resolutions=FIXED";
$closedbugscmd = "http://dev/bugzilla/buglist.cgi?keywords=zodiac-$ver&bug_status=VERIFIED&bug_status=CLOSED";
$lynxcmd = "lynx -dump";
$rrdtool = "/usr/local/rrdtool/bin/rrdtool";
$rrdfile = "/home/ttran/html/drraw/data/$data";
