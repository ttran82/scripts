...
$usageMsg = ""&@crlf& _
			...
			""&@crlf& _
			" This program use klever_vlc_recorder.exe as a basic capture."&@crlf& _
...
Func AutoVlcTwinRecorder()
	...
	For $x = 1 to  $loopCount
		...
		local $stream1name = "vlc_"&$udp1Ip&"_"&$udp1Port&$outputname
		local $stream2name = "vlc_"&$udp2Ip&"_"&$udp2Port&$outputname
		...
		$mycommand1 = "auto_vlc_recorder.exe udpIp="&$udp1Ip&" udpport="&$udp1Port & " captureDur="&$captureDur & $sub_outputFile1
		$mycommand2 = "auto_vlc_recorder.exe udpIp="&$udp2Ip&" udpport="&$udp2Port & " captureDur="&$captureDur & $sub_outputFile2
		;Do not wait
